...
経済成長を促す政策はよく分からない[@levine1992]

- 工場の誘致やインフラの整備は都市の経済を成長させる／効果は短期間・地域的[@greenstone2010; @kline2014]
- 高所得者への減税は経済成長と関係ない[@piketty2014]
  - 最高税率の引き下げ$\leadsto$格差
  - 増税$\neq$労働意欲の低下[@saez2012]
- 制度が整っている場合、低インフレや自由貿易は経済成長と関係ない[@rodrik2004]
- （少なくとも途上国では）リソースの非効率性の是正が重要

$\leadsto$経済成長よりも生活の質の向上（貧困削減、教育、健康……）を目指すべき？

- プログレッサのような条件付き給付[@fiszbein2009]
  - 現金給付$\Leftrightarrow$教育・健康診断
- 就学前教育＋貧困家庭への集中的教育[@fryer2017]
