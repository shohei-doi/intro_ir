...
::: {layout-ncol=2 .content-visible when-format="html"}
...
**積極的平和** (positive peace)^[日本政府の提唱する[積極的平和主義](https://www.mofa.go.jp/mofaj/p_pd/dpr/page1w_000072.html)とは、英訳するとProactive Contribution to Peaceであり、積極的平和とは異なる。]：「構造的暴力が存在しない状態」
...
- **非伝統的安全保障**：非軍事的な脅威に対する安全保障
  ...
  - [**人間の安全保障**](https://www.mofa.go.jp/mofaj/gaiko/oda/bunya/security/index.html) (human security)：日本政府などは守るべき価値を国家ではなく人間として捉え直し、「生存・生活・尊厳に対する広範かつ深刻な脅威」から守るべきとすると提唱
