...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, opacityback=0, colbacktitle=quarto-callout-warning-color!10!white, leftrule=.75mm, breakable, colframe=quarto-callout-warning-color-frame, coltitle=black, arc=.35mm, colback=white, rightrule=.15mm, opacitybacktitle=0.6, titlerule=0mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{地域研究や歴史研究}, bottomrule=.15mm, left=2mm, toprule=.15mm, bottomtitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, opacityback=0, colbacktitle=quarto-callout-warning-color!10!white, leftrule=.75mm, breakable, colframe=quarto-callout-warning-color-frame, coltitle=black, arc=.35mm, colback=white, rightrule=.15mm, opacitybacktitle=0.6, titlerule=0mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{カバーできないトピック}, bottomrule=.15mm, left=2mm, toprule=.15mm, bottomtitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, opacityback=0, colbacktitle=quarto-callout-warning-color!10!white, leftrule=.75mm, breakable, colframe=quarto-callout-warning-color-frame, coltitle=black, arc=.35mm, colback=white, rightrule=.15mm, opacitybacktitle=0.6, titlerule=0mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{引用方法}, bottomrule=.15mm, left=2mm, toprule=.15mm, bottomtitle=1mm]
